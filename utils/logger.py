...
class MetricLogger:
    def __init__(self, save_dir, cfg=None):
        ...
        self.metric_plot = save_dir / 'metric_plot.jpg'
    ...
    def record(self, episode, epsilon, step):
        ...
        axes[0].plot(self.moving_avg_ep_rewards)
        axes[1].plot(self.moving_avg_ep_avg_qs)
        axes[2].plot(self.moving_avg_ep_avg_losses)
        axes[3].plot(self.moving_avg_ep_lengths)
